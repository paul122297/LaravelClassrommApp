                ...
                <div class="card-body">
                        <form method="post" action="{{ route('account.store') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('name') }}" id="name" name="name" placeholder="Input Name" required>
                                  </div>
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input type="email" class="form-control" value="{{ old('email') }}" id="email" name="email" placeholder="Input Email" required>
                                </div>
